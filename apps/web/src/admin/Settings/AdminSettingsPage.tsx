      ...
      <section className="card p-6">
        <div className="flex items-start gap-4">
          <button
            ...
            className="relative grid h-14 w-14 place-items-center overflow-hidden rounded-2xl ring-2 ring-transparent transition hover:ring-brand-300 dark:hover:ring-brand-400"
          ...
          >
            {profile.avatar ? (
              ...
              <div className="grid h-full w-full place-items-center bg-gradient-to-br from-brand-400 to-brand-700 text-xl font-bold text-white">
                {initial}
              </div>
            )}
            <span className="absolute bottom-0 right-0 grid h-5 w-5 place-items-center rounded-full bg-brand-600 text-[10px] text-white shadow ring-2 ring-white dark:ring-surface-300">
              ✎
            </span>
          </button>
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              ...
              <span className={isLocked ? 'badge-warning' : 'badge'}>
